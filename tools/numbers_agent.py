...
# DEPRECATED: Old MANINOS numbers system - commented out for ABOKA
# from .numbers_tools import get_numbers
from .supabase_client import sb
from .supabase_client import BUCKET


# DEPRECATED: Old MANINOS functions - returning stubs for ABOKA
def _to_map(rows: list[dict]) -> Dict[str, float]:
    """DEPRECATED: Old MANINOS function"""
    return {}
