...
<body>
    <div class="header">
        <h1>📋 ABOKA AI</h1>
        <p style="font-size: 18px; font-weight: 600; margin-top: 5px;">Property Inspection Report</p>
    ...
    <div class="footer">
        <p>This report was generated by ABOKA AI - Property Acquisition Assistant</p>
