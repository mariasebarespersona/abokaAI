...
<head>
    <meta charset="UTF-8">
    <title>ABOKA AI - Purchase Agreement</title>
    <style>
        @media print {
...
<body>
    <div class="header">
        <h1>ABOKA AI - PURCHASE AGREEMENT</h1>
    ...
    <div class="footer">
        <p><strong>LEGAL NOTICE:</strong> This is a template contract generated by ABOKA AI.</p>
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-amber-800 leading-relaxed">
                        ...
                        ABOKA AI does not provide legal advice. Signing any contract is at your own risk.
                    </p>
                </div>
            </div>
        </div>
